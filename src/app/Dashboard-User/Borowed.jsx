...
import { FaBook, FaUsers, FaSignOutAlt, FaSearch, FaCog } from "react-icons/fa";
      ...
      <div className="ml-64 p-6 w-full">
        ...
        <div className="flex justify-between items-center mb-6 bg-green-900 p-4 rounded-lg">
          ...
          <div className="flex items-center gap-3">
            <input type="text" placeholder="Search by ID" className="bg-gray-800 text-white p-2 rounded-lg w-64" />
        ...
        <div className="flex gap-4 mb-4">
          <button className={`px-4 py-2 rounded-lg font-medium ${activeTab === "borrowed" ? "bg-gray-300 text-black" : "bg-gray-700 text-white"}`} onClick={() => setActiveTab("borrowed")}>
            Borrowed Books
          </button>
          <button className={`px-4 py-2 rounded-lg font-medium ${activeTab === "returned" ? "bg-purple-500 text-white" : "bg-gray-700 text-white"}`} onClick={() => setActiveTab("returned")}>
            Returned Books
          </button>
        </div>
              ...
              {tableData.map((row, index) => (
                <tr key={index} className="border-b border-gray-300">
                  ...
                  <td className="p-3 text-center">
                    <button className="bg-black text-white px-3 py-1 rounded-lg">Return</button>
                  </td>
                </tr>
              ))}
            </tbody>
