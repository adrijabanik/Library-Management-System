...
//         <p style={subtitleStyle}>Please enter your new password</p>
...
const ResetPasswordForm = () => {
  return (
    <div className="flex h-screen font-sans bg-[#CDF6FB] relative">
      {/* Left Panel */}
      <div className="flex-1 bg-[#9825FC] flex flex-col justify-center items-center p-10 text-white rounded-tr-[70px] rounded-br-[70px]">
      ...
      <div className="flex-1 bg-[#CDF6FB] flex flex-col justify-center items-center p-10 relative">
        ...
        <div className="text-[64px] font-bold mb-5 text-center">Reset Password</div>
        <p className="text-[24px] mb-7 text-center">Please enter your new password</p>
        <input
          type="password"
