  ...
  return (
    <div className="flex h-screen w-full bg-[#CDF6FB]">
      ...
      <Link href="/aotp"
        ...
        <h2 className="text-4xl font-semibold mb-4 font-sans">Reset Password</h2>
        ...
        />
         <input
          ...
          className="w-80 p-2 mb-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
       <Link  href="/asignin" className="bg-black mt-2 text-white px-6 py-2  text-center rounded-xl text-lg w-80 hover:opacity-80">
         Reset Password
        </Link>
      </div>
    </div>
